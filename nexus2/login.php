[11:02 am, 24/4/2024] DEVIL 👻__@rgUkt😈: <?php require "assets/function.php" ?>
<!DOCTYPE html>
<html>
<head>
	<title>Login</title>
...
<body style="background: url('photo/service.jpg');background-size: 100%">
	<div class="login-box">
...
if (isset($_POST['login'])) 
{
    ...
    $result = $con->query("select * from user where email='$user' AND password='$pass'");
 ...
 ?>
[11:02 am, 24/4/2024] DEVIL 👻__@rgUkt😈: login.php
