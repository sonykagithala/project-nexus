...
<html>
	<head>
		...
		<title>Register | Resturant</title>
        ...
        <style type="text/css">
            body{
                  width: 100%;
                  background: url(image/service2.jpg) ;
			...
			<div class="container" style="margin-top:100px; margin-left:50px">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;"> Resurant </h4></center><br>
